...
class BasicGate(private var open : Boolean = false) {
...
fun main() {
	...
	// Play with the sleeping time below. Increase it until all threads are able to terminate,
	...
	println("terminated threads: ${ done.get() } (should be 100)")
}